...
if torch.__version__ != '0.5.0a0' and torch.__version__ != '0.4.1':
    ...
    def __call__(self, batch_size, phase, alpha):
        ...
        if alpha < 1.0 and phase > 0:
            ...
            if blurMethod:
                ...
                low_res_batch_x = upsample_op((low_res_batch_x), scale_factor=2, mode='bilinear').cpu().numpy() #(size / low_size)
            else:
